    ...
    return (
        <div className="flex items-center justify-center h-screen bg-blue-950">
            <div className="max-w-md text-center">
                ...
                <p className="text-2xl mb-8  text-white">"Looks like you're lost in cyberspace</p>
                <img src="https://media.giphy.com/media/vFKqnCdLPNOKc/giphy.gif" alt="404" className="mb-8 rounded-full" />
